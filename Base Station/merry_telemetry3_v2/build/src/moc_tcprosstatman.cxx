...
struct qt_meta_stringdata_TcpRosStatMan_t {
    QByteArrayData data[6];
    char stringdata[52];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_TcpRosStatMan_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_TcpRosStatMan_t qt_meta_stringdata_TcpRosStatMan = {
    {
...
void TcpRosStatMan::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (TcpRosStatMan::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpRosStatMan::connected)) {
                *result = 0;
            }
        }
        {
            typedef void (TcpRosStatMan::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpRosStatMan::disconnected)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject TcpRosStatMan::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TcpRosStatMan.data,
      qt_meta_data_TcpRosStatMan,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TcpRosStatMan.stringdata))
