...
**
** Created: Thu Oct 23 18:16:47 2014
...
static const char qt_meta_stringdata_GLViewer[] = {
    ...
    "toggleStereo(bool)\0key\0FPS_press(QKeyEvent*)\0"
    "pc,transform,camera_id\0"
    "addPointCloud(pointcloud_type*,QMatrix4x4,int)\0"
    "feature_locations_3d\0"
    "addFeatures(const std::vector<Eigen::Vector4f,Eigen::aligned_allocator"
    "<Eigen::Vector4f> >*)\0"
    "transforms,camera_id\0"
    "updateTransforms(QList<QMatrix4x4>*,int)\0"
    "edge_list,camera_id\0"
    "setEdges(const QList<QPair<int,int> >*,int)\0"
    "camera_id\0deleteLastNode(int)\0reset()\0"
    "toggleTriangulation()\0filname\0"
    "drawToPS(QString)\0"
};
...
void GLViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 16: _t->FPS_press((*reinterpret_cast< QKeyEvent*(*)>(_a[1]))); break;
        case 17: _t->addPointCloud((*reinterpret_cast< pointcloud_type*(*)>(_a[1])),(*reinterpret_cast< QMatrix4x4(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 18: _t->addFeatures((*reinterpret_cast< const std::vector<Eigen::Vector4f,Eigen::aligned_allocator<Eigen::Vector4f> >*(*)>(_a[1]))); break;
        case 19: _t->updateTransforms((*reinterpret_cast< QList<QMatrix4x4>*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 20: _t->setEdges((*reinterpret_cast< const QList<QPair<int,int> >*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 21: _t->deleteLastNode((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 22: _t->reset(); break;
        case 23: _t->toggleTriangulation(); break;
        case 24: _t->drawToPS((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
