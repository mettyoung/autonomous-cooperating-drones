...
Q_SIGNALS:
    ...
    void clearClouds();
    void FPS_press(QKeyEvent* e);

public Q_SLOTS:
    void set2DMap(QImage qimage);
    void setFeatureFlowImage(QImage qimage, int camera_id);
    void setRGBDImage(QImage rgb, QImage depth, int camera_id);
