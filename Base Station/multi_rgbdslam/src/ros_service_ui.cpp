...
bool RosUi::services(multi_rgbdslam::rgbdslam_ros_ui::Request  &req,
                     multi_rgbdslam::rgbdslam_ros_ui::Response &res)
{
...
bool RosUi::services_b(multi_rgbdslam::rgbdslam_ros_ui_b::Request  &req,
                       multi_rgbdslam::rgbdslam_ros_ui_b::Response &res )
{
...
bool RosUi::services_s(multi_rgbdslam::rgbdslam_ros_ui_s::Request  &req,
                       multi_rgbdslam::rgbdslam_ros_ui_s::Response &res )
{
...
bool RosUi::services_f(multi_rgbdslam::rgbdslam_ros_ui_f::Request  &req,
                       multi_rgbdslam::rgbdslam_ros_ui_f::Response &res )
{
    ROS_INFO_STREAM("Got Service Request. Command: " << req.command << ". Value: " << req.value );
