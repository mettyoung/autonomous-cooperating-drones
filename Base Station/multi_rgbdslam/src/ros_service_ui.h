...
#include "multi_rgbdslam/rgbdslam_ros_ui_f.h"
#include "multi_rgbdslam/rgbdslam_ros_ui_s.h"
...
public:
    ...
    bool services(multi_rgbdslam::rgbdslam_ros_ui::Request  &req, multi_rgbdslam::rgbdslam_ros_ui::Response &res);
    ///a service-client for all methods with bool as argument: {pause, record}
    bool services_b(multi_rgbdslam::rgbdslam_ros_ui_b::Request  &req, multi_rgbdslam::rgbdslam_ros_ui_b::Response &res);
    ///a service-client for floats, e.g., for changing the maximal depth of a point: {set_max}
    bool services_f(multi_rgbdslam::rgbdslam_ros_ui_f::Request  &req, multi_rgbdslam::rgbdslam_ros_ui_f::Response &res);
    ///a service-client for commands with string arguments, e.g. a filename
    bool services_s(multi_rgbdslam::rgbdslam_ros_ui_s::Request  &req, multi_rgbdslam::rgbdslam_ros_ui_s::Response &res);
Q_SIGNALS:
