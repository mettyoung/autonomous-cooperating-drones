...
(cl:in-package multi_rgbdslam-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <rgbdslam_ros_ui_s-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'rgbdslam_ros_ui_s-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name multi_rgbdslam-srv:<rgbdslam_ros_ui_s-request> is deprecated: use multi_rgbdslam-srv:rgbdslam_ros_ui_s-request instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <rgbdslam_ros_ui_s-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_rgbdslam-srv:command-val is deprecated.  Use multi_rgbdslam-srv:command instead.")
  (command m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <rgbdslam_ros_ui_s-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_rgbdslam-srv:value-val is deprecated.  Use multi_rgbdslam-srv:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<rgbdslam_ros_ui_s-request>)))
  ...
  "multi_rgbdslam/rgbdslam_ros_ui_sRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'rgbdslam_ros_ui_s-request)))
  "Returns string type for a service object of type 'rgbdslam_ros_ui_s-request"
  "multi_rgbdslam/rgbdslam_ros_ui_sRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <rgbdslam_ros_ui_s-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'rgbdslam_ros_ui_s-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name multi_rgbdslam-srv:<rgbdslam_ros_ui_s-response> is deprecated: use multi_rgbdslam-srv:rgbdslam_ros_ui_s-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<rgbdslam_ros_ui_s-response>)))
  ...
  "multi_rgbdslam/rgbdslam_ros_ui_sResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'rgbdslam_ros_ui_s-response)))
  "Returns string type for a service object of type 'rgbdslam_ros_ui_s-response"
  "multi_rgbdslam/rgbdslam_ros_ui_sResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'rgbdslam_ros_ui_s)))
  ...
  "multi_rgbdslam/rgbdslam_ros_ui_s")